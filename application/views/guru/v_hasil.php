              ...
              <div class="row">
                <div class="col-sm-12">
                  <table class="table table-bordered no-footer">
                    <thead>
                      <tr role="row">
                        <th width="5%" class="sorting_disabled">No</th>
                        <th width="20%" class="sorting_disabled">Nama Tes</th>
                        <th width="25%" class="sorting_disabled">Nama Guru</th>
                        <th width="20%" class="sorting_disabled">Mata Pelajaran</th>
                        <th width="10%" class="sorting_disabled">Jumlah Soal</th>
                        <th width="10%" class="sorting_disabled">Waktu</th>
                        <th width="10%" class="sorting_disabled">Aksi</th>
                      </tr>
                    </thead>
                    <tbody>
